								...
								<div class="col-md-3">
									<div class="panel panel-default">
										...
										<div class="panel-footer text-center">
											Category (VEG/NON VEG):  <?php echo $pfrow['ptype']; ?>
										</div>
                                                                                <div class="panel-footer text-center">
											Company:  <?php echo $pfrow['company']; ?>
										</div>                                                                            
										<div class="panel-footer text-center">
							...
							?>
								<div class="col-md-3">
									<div class="panel panel-default">
										...
										<div class="panel-footer text-center">
											Category (VEG/NON VEG): <?php  echo $prow['ptype'];  ?>
										</div>                                                                            
										<div class="panel-footer text-center">
											Company: <?php  echo $prow['company'];  ?>
										</div>
                                                                                <div class="panel-footer text-center">
...
<footer><center>Svastikka Project Made By Manshu </center></footer>
</html>