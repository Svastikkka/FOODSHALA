            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                $sql="select * from purchase_detail left join product on product.productid=purchase_detail.productid where purchaseid='".$row['purchaseid']."' and product.company='".$_SESSION['res_username']."'";
